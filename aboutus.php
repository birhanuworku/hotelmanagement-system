		...
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "images/a.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "images/b.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
					<center><h4 style = "color:rgba(0, 255, 0, 1);">Extra Bed</h4></center>
					<center><label style = "color:red;"> 800.00</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "images/c.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
				...
				<br />
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "images/d.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "images/e.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
